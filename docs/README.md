...
| [OFFICE_DEPLOYMENT.md](OFFICE_DEPLOYMENT.md) | Isolated Docker deployment, Tailscale Funnel, and the manual GitHub Actions release workflow. | You're deploying or operating the office test server. |
