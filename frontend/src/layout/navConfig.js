...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { key: "facilities", label: "Facilities", path: "/facilities", icon: "facility", perm: "facilities.manage" },
      { key: "locations", label: "Locations", path: "/locations", icon: "location", perm: "facilities.manage" },
